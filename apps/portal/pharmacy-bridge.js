...
(function () {
  ...
  function connectRealtime() {
    ...
    // No signed-in identity → don't join any room (prevents a logged-out portal
    // from receiving a former pharmacy's realtime events).
  ...
  // Drop the realtime socket — call on logout so no more events arrive.
