    ...
    <div style={{ flex: 1, background: C.cream, display: 'flex', flexDirection: 'column', overflow: 'auto' }}>
      ...
      <div style={{ background: '#5B8EE0', padding: '20px 20px 28px', borderRadius: '0 0 28px 28px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 16, padding: '12px 16px', background: 'rgba(255,255,255,0.15)', borderRadius: 14 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontFamily: fonts.body, fontSize: 14, fontWeight: 700, color: C.white }}>WhatsApp alerts</div>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 20px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                ...
                <Btn variant="secondary" style={{ flex: 1, minHeight: 44, fontSize: 14 }} icon="💬">WhatsApp</Btn>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <div style={{ fontFamily: fonts.body, fontSize: 15, fontWeight: 700, color: C.text }}>WhatsApp alert preview</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button onClick={() => setMode('phone')} style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontFamily: fonts.body, fontSize: 13, color: C.textMuted, lineHeight: 1.5 }}>
                  Send an invite link via WhatsApp or SMS to their number.
                </div>
                <div style={{ marginTop: 8 }}>
                  <Pill color={C.sage}>WhatsApp · SMS · Works remotely</Pill>
                </div>
              </div>
              <span style={{ color: C.textMuted, fontSize: 22 }}>›</span>
            </button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
            ...
            <div style={{ display: 'flex', gap: 12, width: '100%' }}>
              <button style={{
                ...
                <span style={{ fontFamily: fonts.body, fontSize: 14, fontWeight: 700, color: C.white }}>Share on WhatsApp</span>
              </button>
              <button style={{
        ...
        {mode === 'phone' && !sent && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                {[['💬', 'WhatsApp', '#25D366'], ['💬', 'SMS', C.warmGray]].map(([icon, label, color]) => (
                  <div key={label} style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, paddingTop: 20 }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: fonts.body, fontSize: 15, color: C.textMuted, lineHeight: 1.6 }}>
                {name} will receive a WhatsApp message with a link to join SaathiPill as your caregiver.
              </div>
            </div>
