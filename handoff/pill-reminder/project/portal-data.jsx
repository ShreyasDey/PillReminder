...
const ACTIVITY = [
  ...
  { id: 'a6', time: '3h ago', kind: 'delivered', icon: '⇨', text: 'Home delivery completed — Priya Deshpande, ₹890' },
...
const REFILLS = [
  ...
  { id: 'SP-1236', patientId: 2, name: 'Lakshmi Iyer', placed: '4h ago', placedTime: '9:18 AM', status: 'pending', delivery: 'home', amount: 1420, items: [{ med: 'Telmisartan 40mg', qty: 30 }, { med: 'Amlodipine 5mg', qty: 30 }] },
  { id: 'SP-1237', patientId: 3, name: 'Mohammed Ansari', placed: '5h ago', placedTime: '8:45 AM', status: 'pending', delivery: 'home', amount: 4280, items: [{ med: 'Clopidogrel 75mg', qty: 30 }, { med: 'Aspirin 75mg', qty: 30 }, { med: 'Atorvastatin 20mg', qty: 30 }], urgent: true },
  ...
  { id: 'SP-1239', patientId: 5, name: 'Vikram Reddy', placed: '3h ago', placedTime: '10:42 AM', status: 'confirmed', delivery: 'home', amount: 2640, items: [{ med: 'Telmisartan 40mg', qty: 30 }, { med: 'Amlodipine 5mg', qty: 30 }, { med: 'Aspirin 75mg', qty: 30 }] },
  { id: 'SP-1220', patientId: 4, name: 'Priya Deshpande', placed: 'yesterday', placedTime: 'Yesterday 11:30 AM', status: 'delivered', delivery: 'home', amount: 890, items: [{ med: 'Thyronorm 50mcg', qty: 30 }] },
  ...
  { id: 'SP-1242', patientId: 6, name: 'Sunita Joshi', placed: '1h ago', placedTime: '12:30 PM', status: 'pending', delivery: 'home', amount: 2120, items: [{ med: 'Metformin 500mg', qty: 60 }, { med: 'Glimepiride 2mg', qty: 30 }, { med: 'Atorvastatin 20mg', qty: 30 }] },
...
Object.assign(window, {
  ...
  adherenceTimeline, refillHistory,
});
